    ...
    return (
        <section className="flex flex-col gap-20 h-screen items-center justify-center">
            <motion.div
                ...
                className="flex flex-row gap-[955px]"
            >
            ...
            <div className="grid grid-cols-3 gap-10">
                {projectsData.map((project, index) => (
                    <motion.div 
                        key={index}
                        className="flex flex-col gap-8 shadow-lg p-4 text-center rounded-lg bg-white transform hover:scale-105 transition duration-300 ease-in-out"
